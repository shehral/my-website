        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              <p className="text-red-500 font-space tracking-wider">MSCS STUDENT AT NORTHEASTERN UNIVERSITY</p>
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-sora font-extrabold text-gradient animate-gradient">
                Ali Shehral
              </h1>
              <p className="text-xl md:text-2xl max-w-2xl text-gray-300 font-space">
                President of NEURAI Lab · Builder of AI & Quant Finance tools · Guitarist & Ducati rider
              </p>
            </div>

            <div className="flex flex-wrap gap-4">
              <Button asChild size="lg" className="bg-red-700 hover:bg-red-600 text-white border-none">
              ...
              <div className="flex space-x-3">
                <Button
                  ...
                  size="icon"
                  asChild
                  className="rounded-full border-gray-700 hover:border-red-500 hover:bg-red-950"
                >
          ...
          <div className="relative w-full max-w-[300px] mx-auto lg:mx-0">
            <div className="aspect-square rounded-full bg-gradient-to-br from-red-700 to-red-950 p-1 animate-float">
            ...
            <div className="absolute -bottom-4 -right-4 bg-black p-2 rounded-lg border border-gray-800">
              <div className="px-3 py-1 bg-red-950 rounded-full text-sm font-medium text-white">AI Researcher</div>
            </div>
          </div>
        </div>

        <section className="mt-24 max-w-3xl space-y-6">
          <h2 className="text-3xl text-gradient font-sora font-bold">What I'm doing now</h2>
          <div className="space-y-4 text-gray-300 text-lg">
            <div className="flex items-start gap-3 p-4 rounded-lg bg-gradient-card hover-glow border border-gray-800">
